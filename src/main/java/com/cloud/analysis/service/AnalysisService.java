...
public interface AnalysisService {
    ...
    default Survey_analysis_DTO TransferEntityToDTO(Survey_analysis_DTO survey_analysis_DTO) {
        Survey_analysis_DTO dto = Survey_analysis_DTO.builder()
                .type(survey_analysis_DTO.getType())
                .subject(survey_analysis_DTO.getSubject())
                .build();
        return dto;
    }
}

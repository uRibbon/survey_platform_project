  ...
  return(
    <>
      ...
      <CCard className="m-3">
        ...
        <CCardBody>
          <CFormCheck type="radio" name="question2" id="question2" label="1. 춘식이" defaultChecked/>
      ...
      <CCard className="m-3">
        ...
        <CCardBody>
          <CFormCheck type="checkbox" name="question3" id="question3" label="1. 춘식이" defaultChecked/>
      ...
      <CCard className="m-3">
        ...
        <CCardBody>
          ...
          <CFormCheck type="radio" name="question4" id="question4" label="아니오" defaultChecked/>
        </CCardBody>
      </CCard>
      <CCard className="m-3">

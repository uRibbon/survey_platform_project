...
const Charts = () => {
  ...
  const [questions, setQuestions] = useState([
    <QuestionModal answerType={1} question_num={1} key={1}/>,
    <QuestionModal answerType={2} question_num={2} key={2}/>,
    <QuestionModal answerType={1} question_num={3} key={3}/>,
  ])
      ...
      <CRow className="mb-3">
        ...
        <CForm style={tempStyle}>
          <CFormTextarea
            ...
            value="이것은 첫번째 주관식 질문에 대한 설문자의 더미 답변입니다."
          ></CFormTextarea>
        </CForm>
    </CContainer>
    ...
    <CContainer>
      <CRow className="mb-3">
        ...
        <CRow style={tempStyle}>
          ...
          <CFormCheck label="두번째 객관식 질문의 보기 2번입니다." checked/>
    ...
    <CContainer>
      <CRow className="mb-3">
        ...
        <CRow style={tempStyle}>
          ...
          <CFormCheck label="세번째 객관식 질문의 보기 3번입니다." checked/>
      ...
      <CRow className="mb-3">
        ...
        <CForm style={tempStyle}>
          <CFormTextarea
            ...
            rows="3"
            text="Must be 8-20 words long."
            value="이것은 네번째 주관식 질문에 대한 설문자의 더미 답변입니다."
          ></CFormTextarea>
        </CForm>
    </CContainer>
